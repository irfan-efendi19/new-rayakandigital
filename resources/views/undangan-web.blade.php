...
<head>
    ...
    <x-meta
        title="Undangan Web - Rayakan Digital"
                    ...
                    <div class="relative w-56 md:w-64 mx-auto">
                        <div class="bg-[#1c1c1e] rounded-[2.5rem] p-2 shadow-2xl">
                            <div class="bg-[#2d1b0e] rounded-[2rem] overflow-hidden relative" style="aspect-ratio:9/19">
                                <div
                                    class="absolute top-3 left-1/2 -translate-x-1/2 w-16 h-3 bg-black/70 rounded-full z-10">
                                </div>
                                <div
                                    ...
                                    <div
                                        class="absolute bottom-20 left-4 w-20 h-20 rounded-full bg-primary-500/10 blur-2xl">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-20 bg-white dark:bg-secondary-800" id="fitur">
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    <div class="bg-neutral-50 rounded-3xl p-6 overflow-hidden relative shadow-soft">
                        ...
                        <div class="mt-5 grid grid-cols-4 gap-1.5 rounded-xl overflow-hidden">
                            ...
                            <div class="bg-primary-100 rounded-xl h-11"
                            ...
                            <div class="bg-primary-200 rounded-xl h-11"
                                style="background:linear-gradient(135deg,#bbf7d0,#4ade80)"></div>
                            <div class="bg-primary-100 rounded-xl h-11"
                                style="background:linear-gradient(135deg,#bfdbfe,#60a5fa)"></div>
                        </div>
                    </div>
                    <div class="bg-neutral-50 rounded-3xl p-6 relative overflow-hidden shadow-soft">
                        <div class="w-10 h-10 bg-primary-100 rounded-xl flex items-center justify-center mb-4">
                        ...
                        <div class="mt-5 w-full h-24 rounded-2xl overflow-hidden relative bg-blue-50">
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-full h-full"
                                    ...
                                    <div class="absolute inset-0 flex items-center justify-center">
                                        <div
                                            class="w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center shadow-soft">
                    ...
                    <div class="bg-neutral-50 rounded-3xl p-6 shadow-soft">
                        <div class="w-10 h-10 bg-primary-100 rounded-xl flex items-center justify-center mb-4">
