...
<body class="font-sans antialiased bg-neutral-50 dark:bg-secondary-900 text-secondary-800 dark:text-neutral-200">
    ...
    <!-- ───────────────── HERO ───────────────── -->
    <section class="relative overflow-hidden bg-gradient-to-br from-white via-primary-50/30 to-secondary-50 dark:from-secondary-900 dark:via-secondary-900 dark:to-secondary-900 min-h-[92vh] flex items-center">
        ...
        <div class="relative max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal">
                ...
                <h1 class="text-5xl md:text-6xl font-heading font-extrabold leading-tight text-secondary-900 dark:text-neutral-100 mb-6">
                    Check-in Tamu,<br />
            ...
            <div class="relative reveal" style="transition-delay:.15s">
                <div class="relative rounded-3xl overflow-hidden shadow-soft border border-primary-100">
                    <div class="bg-gradient-to-br from-amber-50 to-primary-50 dark:from-secondary-800 dark:to-secondary-800 aspect-[4/3] flex items-center justify-center">
                        <div class="bg-white dark:bg-secondary-800 rounded-2xl p-6 shadow-soft w-56 text-center mx-auto">
                            <div class="text-3xl font-mono font-bold text-secondary-800 dark:text-neutral-200 tracking-widest mb-3">09822106</div>
                ...
                <div class="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white dark:bg-secondary-800 rounded-2xl shadow-soft px-5 py-3 flex items-center gap-3 border border-primary-100 whitespace-nowrap">
    ...
    <section id="fitur" class="bg-white dark:bg-secondary-800 py-24">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-heading font-bold text-secondary-900 dark:text-neutral-100 mb-4">Fitur Cerdas untuk Acara Anda</h2>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white dark:bg-secondary-800 rounded-3xl p-8 shadow-soft border border-neutral-100 dark:border-secondary-700 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 dark:text-neutral-100 mb-3">Manajemen RSVP Real-time</h3>
                    ...
                    <div class="rounded-2xl overflow-hidden bg-neutral-50 h-28 flex items-end gap-2 px-4 pb-3 border border-neutral-100 dark:border-secondary-700">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-secondary-800 rounded-3xl p-8 shadow-soft border border-neutral-100 dark:border-secondary-700 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 dark:text-neutral-100 mb-3">Data Terenkripsi</h3>
                ...
                <div class="bg-white dark:bg-secondary-800 rounded-3xl p-8 shadow-soft border border-neutral-100 dark:border-secondary-700 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                    ...
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 dark:text-neutral-100 mb-2">Quick QR Check-in</h3>
    ...
    <section id="whatsapp" class="py-24 bg-neutral-50">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div class="bg-secondary-800 rounded-[2.5rem] overflow-hidden aspect-[9/18]">
                            ...
                            <div class="bg-[#ece5dd] p-3 space-y-3 h-full">
                                <div class="bg-white dark:bg-secondary-800 rounded-2xl rounded-tl-none p-3 max-w-[80%] shadow-sm">
                                    <p class="text-xs text-secondary-800 dark:text-neutral-200">Halo Budi! 👋 Anda terdaftar sebagai tamu VIP di
                                ...
                                <div class="ml-auto bg-[#dcf8c6] rounded-2xl rounded-tr-none p-3 max-w-[75%] shadow-sm">
                                    <p class="text-xs text-secondary-800 dark:text-neutral-200">Terima kasih! Siap hadir 🎉</p>
            ...
            <div class="reveal" style="transition-delay:.1s">
                <h2 class="text-4xl font-heading font-bold text-secondary-900 dark:text-neutral-100 mb-8">Otomasi WhatsApp yang Personal</h2>
                <div class="space-y-6">
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            1</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 dark:text-neutral-100 mb-1">Kirim Undangan Masal</h4>
                    ...
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            2</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 dark:text-neutral-100 mb-1">Blast Notifikasi Pengingat</h4>
                    ...
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            3</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 dark:text-neutral-100 mb-1">Ucapan Terima Kasih Instan</h4>
