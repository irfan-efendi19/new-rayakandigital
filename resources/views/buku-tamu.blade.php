...
<body class="font-sans antialiased bg-neutral-50 text-secondary-800">
    ...
    <!-- ───────────────── HERO ───────────────── -->
    <section class="relative overflow-hidden bg-gradient-to-br from-white via-primary-50/30 to-secondary-50 min-h-[92vh] flex items-center">
        ...
        <div class="relative max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
            ...
            <!-- Left -->
            <div class="reveal">
                <span class="inline-flex items-center gap-2 bg-primary-100 border border-primary-200 text-primary-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 tracking-wide uppercase">
                    <i class="fa-regular fa-star text-primary-500 text-[10px]"></i>
                    Premium Event Solution
                </span>
                <h1 class="text-5xl md:text-6xl font-heading font-extrabold leading-tight text-secondary-900 mb-6">
                    Check-in Tamu,<br />
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="#"
                        class="border-2 border-neutral-300 hover:border-primary-500 text-secondary-700 hover:text-primary-500 font-semibold px-7 py-3.5 rounded-full transition-all">
                        Lihat Demo
                    </a>
                </div>
            </div>
            ...
            <div class="relative reveal" style="transition-delay:.15s">
                <div class="relative rounded-3xl overflow-hidden shadow-soft border border-primary-100">
                    <div class="bg-gradient-to-br from-amber-50 to-primary-50 aspect-[4/3] flex items-center justify-center">
                        <div class="bg-white rounded-2xl p-6 shadow-soft w-56 text-center mx-auto">
                            <div class="text-3xl font-mono font-bold text-secondary-800 tracking-widest mb-3">09822106</div>
                ...
                <div class="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-soft px-5 py-3 flex items-center gap-3 border border-primary-100 whitespace-nowrap">
                    <div class="w-9 h-9 rounded-full bg-primary-500 flex items-center justify-center text-white text-sm">
                        <i class="fa-solid fa-qrcode"></i>
                    </div>
                    <div>
                        <p class="font-bold text-secondary-900 text-sm">Scan &amp; Check-in</p>
    ...
    <section id="fitur" class="bg-white py-24">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-heading font-bold text-secondary-900 mb-4">Fitur Cerdas untuk Acara Anda</h2>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-soft border border-neutral-100 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 mb-3">Manajemen RSVP Real-time</h3>
                    ...
                    <ul class="space-y-2 mb-6 text-sm text-secondary-700 font-medium">
                    ...
                    <div class="rounded-2xl overflow-hidden bg-neutral-50 h-28 flex items-end gap-2 px-4 pb-3 border border-neutral-100">
                ...
                <div class="bg-primary-500 rounded-3xl p-8 text-white reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1" style="transition-delay:.1s">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-soft border border-neutral-100 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 mb-3">Data Terenkripsi</h3>
                    <p class="text-neutral-500 leading-relaxed">Keamanan data tamu adalah prioritas kami. Semua informasi
                ...
                <div class="bg-white rounded-3xl p-8 shadow-soft border border-neutral-100 reveal transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                    ...
                    <div class="mb-4 rounded-2xl overflow-hidden bg-secondary-800 h-28 flex items-center justify-center">
                        <div class="grid grid-cols-5 gap-1 p-3 opacity-80">
                            <div class="bg-white w-3 h-3 rounded-sm"></div>
                    ...
                    <h3 class="text-2xl font-heading font-bold text-secondary-900 mb-2">Quick QR Check-in</h3>
    ...
    <section id="whatsapp" class="py-24 bg-neutral-50">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="bg-secondary-900 rounded-[3rem] p-3 shadow-2xl">
                        <div class="bg-secondary-800 rounded-[2.5rem] overflow-hidden aspect-[9/18]">
                            <div class="bg-[#075e54] p-3 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-primary-500 flex items-center justify-center text-white text-xs font-bold">R</div>
                                <div>
                            ...
                            <div class="bg-[#ece5dd] p-3 space-y-3 h-full">
                                <div class="bg-white rounded-2xl rounded-tl-none p-3 max-w-[80%] shadow-sm">
                                    <p class="text-xs text-secondary-800">Halo Budi! 👋 Anda terdaftar sebagai tamu VIP di
                                ...
                                <div class="bg-white rounded-2xl rounded-tl-none p-3 max-w-[80%] shadow-sm">
                                    <div class="bg-secondary-800 rounded-xl p-2 mb-2 text-center">
                                        ...
                                        <div class="grid grid-cols-3 gap-0.5 w-10 mx-auto">
                                            <div class="bg-white w-2 h-2"></div>
                                ...
                                <div class="ml-auto bg-[#dcf8c6] rounded-2xl rounded-tr-none p-3 max-w-[75%] shadow-sm">
                                    <p class="text-xs text-secondary-800">Terima kasih! Siap hadir 🎉</p>
            ...
            <div class="reveal" style="transition-delay:.1s">
                <h2 class="text-4xl font-heading font-bold text-secondary-900 mb-8">Otomasi WhatsApp yang Personal</h2>
                <div class="space-y-6">
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            1</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 mb-1">Kirim Undangan Masal</h4>
                            <p class="text-neutral-500 text-sm leading-relaxed">Kirim ribuan pesan undangan personal hanya
                                dengan satu klik.</p>
                        </div>
                    </div>
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            2</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 mb-1">Blast Notifikasi Pengingat</h4>
                    ...
                    <div class="flex gap-5 items-start">
                        <div class="w-10 h-10 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-soft">
                            3</div>
                        <div>
                            <h4 class="font-bold text-secondary-900 mb-1">Ucapan Terima Kasih Instan</h4>
                            <p class="text-neutral-500 text-sm leading-relaxed">Pesan otomatis terkirim segera setelah tamu
    ...
    <section id="harga" class="bg-gradient-to-br from-primary-600 to-primary-800 py-20">
        <div class="max-w-2xl mx-auto px-6 text-center reveal">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#"
                    class="bg-white text-primary-500 font-bold px-8 py-3.5 rounded-full hover:bg-primary-50 transition-colors shadow-soft">
                    Konsultasi Gratis
                </a>
                <a href="#"
