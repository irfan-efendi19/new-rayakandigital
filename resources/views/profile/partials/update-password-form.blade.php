<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password" class="mt-1.5 block w-full"
        ...
        <div>
            ...
            <x-text-input id="update_password_password" name="password" type="password" class="mt-1.5 block w-full"
