        ...
        <div id="cover" class="cover">
            ...
            <div class="cover-content">
                <div class="cover-frame">
                    ...
                    @else
                        <div class="cover-frame-inner cover-frame-placeholder">
                            <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1">
                                <path d="M50 20C35 20 20 35 20 50s15 30 30 30 30-15 30-30S65 20 50 20z" opacity="0.3" />
                                <path d="M50 35c-8 0-15 7-15 15s7 15 15 15 15-7 15-15-7-15-15-15z" opacity="0.2" />
                            </svg>
                        </div>
                    @endif
                </div>
                ...
                <h1 class="cover-title">
                    {{ $coupleFirst }}<br>
                    <span class="cover-title-sep">&amp;</span><br>
                    {{ $coupleSecond }}
                </h1>
                @php
                    ...
                    <section class="section hero-section">
                        <div class="container text-center">
                            <div class="hero-floral">
                                <span class="hero-floral-leaf"></span>
                                <span class="hero-floral-dot">&#10087;</span>
                                <span class="hero-floral-leaf"></span>
                            </div>
                                                                ...
                                                                <div class="container text-center">
                                                                    ...
                                                                    @else
                                                                        <form id="wishForm" class="wish-form" action="{{ route('wish.store', $invitation) }}" method="POST">
                                                                            @csrf
                                                                            <input type="text" name="guest_name" value="{{ $guest ? $guest->name : '' }}" placeholder="Nama Anda"
...
$appUrl = config('app.url');
                                        @endphp
                                        <p class="footer-credit">Dibuat dengan <a href="{{ $appUrl }}" target="_blank">RayakanDigital</a>
                                        </p>
                                    </div>
                                </footer>
