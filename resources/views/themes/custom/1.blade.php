...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/custom/1/assets/css/style.css') }}">
</head>
<body>
...
<div id="cover" class="cover">
    <div class="cover-bg">
        <img src="{{ asset('themes/custom/1/assets/images/hero-bg.svg') }}" alt="" class="cover-bg-img">
...
<script src="{{ asset('themes/custom/1/assets/js/script.js') }}"></script>
</body>
</html>
