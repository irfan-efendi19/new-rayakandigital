                        ...
                        <div class="p-6">
                            ...
                            @auth
                                ...
                                @else
                                    ...
                                    " id="pricing-{{ $package->package_code }}">Pilih {{ $package->package_name }}</a>
                                @endif
                            @else
                                @if($package->package_code === 'free')
                                    <a href="{{ route('register') }}" class="mt-8 block w-full bg-gray-800 border border-gray-800 rounded-xl py-2.5 text-sm font-semibold text-white text-center hover:bg-gray-900 transition-colors" id="pricing-{{ $package->package_code }}">Daftar Gratis</a>
                                @else
