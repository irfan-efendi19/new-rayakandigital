    ...
    <div class="py-16 md:py-24 bg-tertiary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12 md:mb-16">
                ...
                <p
                    class="mt-2 text-3xl md:text-4xl leading-8 md:leading-10 font-extrabold tracking-tight text-secondary-900 font-heading">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="space-y-6">
                    <!-- Contact Cards -->
                    <div
                        class="bg-white rounded-2xl shadow-soft border border-neutral-100 p-6 hover:shadow-xl transition-all duration-300">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-neutral-600 text-sm leading-relaxed">Jl. Celebration No. 123, Kawasan
                                    Digital Creative, Jakarta Selatan 12345</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-primary-600 mt-1">💬 Respon cepat biasanya kurang dari 30 menit
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-gradient-to-r from-primary-50 to-primary-100 rounded-2xl p-5 border border-primary-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-secondary-600 text-xs">Tim Customer Success kami biasanya merespon dalam
                                    waktu kurang dari 30 menit melalui WhatsApp.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-neutral-100 p-6 md:p-8">
                    ...
                    <form class="space-y-5">
                        <div>
                            <label class="block text-sm font-semibold text-secondary-700 mb-2">Nama Lengkap</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-secondary-700 mb-2">Alamat Email</label>
                            <input type="email" placeholder="nama@email.com"
                                class="w-full px-4 py-3 border border-neutral-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all duration-200 bg-tertiary/50">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-secondary-700 mb-2">Subjek Pesan</label>
                            <select
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-secondary-700 mb-2">Pesan Anda</label>
                            <textarea rows="4" placeholder="Tuliskan detail pertanyaan Anda di sini..."
