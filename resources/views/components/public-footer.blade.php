<footer class="bg-footer-bg px-16 pt-14 max-w-screen-xl mx-auto rounded-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12">
        ...
        <div>
            ...
            <p class="text-footer-muted text-sm leading-relaxed mb-7 max-w-[210px]">
                Platform pembuatan undangan digital terdepan di Indonesia. Mudah, elegan, dan penuh fitur modern.
            </p>
            <div class="flex gap-2.5">
                <a href="#" aria-label="Website"
                    class="w-9 h-9 rounded-full bg-footer-pill flex items-center justify-center text-footer-muted hover:bg-primary hover:text-white transition-all duration-200 hover:-translate-y-0.5">
        ...
        @endphp
        <div>
            <p class="text-[11px] font-semibold tracking-widest uppercase text-footer-subtle mb-5">Metode Pembayaran
            </p>
            <div class="grid grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-3">
                @foreach($logos as $logo)
                <div
                    class="bg-white border border-footer-border rounded-lg h-12 overflow-hidden flex items-center justify-center p-2">
    ...
    <hr class="border-footer-border" />

    <div class="py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
        <p class="text-[13px] text-footer-subtle">&copy; {{ date('Y') }} Rayakan Digital. All rights reserved.</p>
        <p class="text-[13px] text-footer-subtle flex items-center gap-1.5">
