<footer class="bg-footer-bg dark:bg-secondary-900 px-16 pt-14 max-w-screen-xl mx-auto rounded-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12">
        ...
        <nav aria-label="Layanan">
            <p class="text-[11px] font-semibold tracking-widest uppercase text-footer-subtle dark:text-neutral-500 mb-5">Layanan</p>
        ...
        <nav aria-label="Perusahaan">
            <p class="text-[11px] font-semibold tracking-widest uppercase text-footer-subtle dark:text-neutral-500 mb-5">Perusahaan</p>
            <ul class="flex flex-col gap-3.5">
                <li>
        ...
        @endphp
        <div>
            <p class="text-[11px] font-semibold tracking-widest uppercase text-footer-subtle dark:text-neutral-500 mb-5">Metode Pembayaran
            </p>
    ...
    <div class="py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
        <p class="text-[13px] text-footer-subtle dark:text-neutral-500">&copy; {{ date('Y') }} Rayakan Digital. All rights reserved.</p>
