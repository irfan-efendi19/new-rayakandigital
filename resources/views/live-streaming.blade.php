...
<body class="font-sans antialiased bg-neutral-50 text-secondary-800">
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-white via-primary-50/30 to-secondary-50 pt-16 pb-24">
        ...
        <div class="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="anim-fade-up">
                <span class="inline-flex items-center gap-2 bg-primary-100 text-primary-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
            ...
            <div class="anim-fade-up anim-d2 relative">
                <div class="rounded-2xl overflow-hidden shadow-2xl aspect-video relative bg-gradient-to-br from-primary-100 to-neutral-200">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm border border-white/40 flex items-center justify-center cursor-pointer hover:bg-white/30 transition-colors">
    ...
    <section class="py-24 bg-gradient-to-br from-secondary-800 to-secondary-900 relative overflow-hidden">
        <div class="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-primary-800/30 blur-3xl pointer-events-none"></div>
        <div class="absolute -bottom-16 -right-16 w-72 h-72 rounded-full bg-primary-700/20 blur-3xl pointer-events-none"></div>
