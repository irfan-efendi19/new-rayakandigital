    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-0.5">Riwayat pengiriman pesan WhatsApp ke tamu undangan.</p>
            </div>
                ...
                <div class="p-6">
                    @if($logs->isEmpty())
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-base font-bold text-secondary-800 dark:text-neutral-100">Belum ada pengiriman</h3>
                            ...
                            <table class="min-w-full divide-y divide-neutral-200 dark:divide-secondary-700">
                                <thead class="bg-neutral-50 dark:bg-secondary-900">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3.5 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Status</th>
                                        <th scope="col" class="px-6 py-3.5 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Pesan</th>
                                        <th scope="col" class="px-6 py-3.5 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Error</th>
                                        <th scope="col" class="px-6 py-3.5 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Waktu Kirim</th>
                                        <th scope="col" class="px-6 py-3.5 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Dibuat</th>
                                    </tr>
                                </thead>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @php
                                                    $statusBadge = match($log->status) {
                                                        ...
                                                        'queued' => ['bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200', 'Terjadwal'],
                                                        'pending' => ['bg-amber-100 dark:bg-amber-900/50 text-amber-800 dark:text-amber-200', 'Diproses'],
                                                        default => ['bg-neutral-100 dark:bg-secondary-700 text-neutral-600 dark:text-neutral-400', ucfirst($log->status)],
                                                    };
                                                @endphp
