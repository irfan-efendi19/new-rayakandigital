                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">
                                    Informasi Mempelai</h3>

                                <div class="space-y-6">
                                    <!-- Mempelai Wanita -->
                                    <div class="bg-gray-50 p-4 rounded-xl space-y-4">
                                        <h4 class="font-semibold text-sm text-indigo-700">
                                            Mempelai Wanita</h4>
                                                ...
                                                <div class="mt-1 flex items-center gap-4">
                                                    <div class="relative flex-shrink-0">
                                                        <img id="bride-preview"
                                                            ...
                                                            alt="Bride photo"
                                                            class="w-16 h-16 object-cover rounded-full border {{ $invitation->bride_photo ? '' : 'hidden' }}">
                                                        <div id="bride-preview-placeholder"
                                                            class="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center text-gray-400 text-xs font-semibold {{ $invitation->bride_photo ? 'hidden' : '' }}">
                                                            No Photo
                                                        </div>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <button type="button" data-crop-target="bride_photo_input"
                                                            class="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-md text-sm font-semibold hover:bg-indigo-100 transition">
                                                            Pilih & Crop
                                                            Foto
                                                        </button>
                                                ...
                                                <div class="mt-1 flex items-center gap-4">
                                                    <div class="relative flex-shrink-0">
                                                        <img id="groom-preview"
                                                            ...
                                                            alt="Groom photo"
                                                            class="w-16 h-16 object-cover rounded-full border {{ $invitation->groom_photo ? '' : 'hidden' }}">
                                                        <div id="groom-preview-placeholder"
                                                            class="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center text-gray-400 text-xs font-semibold {{ $invitation->groom_photo ? 'hidden' : '' }}">
                                                            No Photo
                                                        </div>
                                                    </div>
                                                    <div>
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <button type="button" id="add-event-btn"
                                        class="inline-flex items-center px-3 py-1.5 text-sm font-medium rounded-md text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition">
                                        + Tambah Acara Baru
                                    </button>
                                </div>

                                @error('events') <span class="text-red-500 text-xs block mb-2">{{ $message }}</span>
                                @enderror
                                        ...
                                        <div class="event-card bg-gray-50 p-4 rounded-xl border border-gray-200">
                                            ...
                                            <div class="flex items-center justify-between mb-4">
                                                ...
                                                <div class="flex items-center gap-1">
                                                    <button type="button"
                                                        class="move-up p-1 text-gray-400 hover:text-gray-600"
                                                    ...
                                                    <button type="button"
                                                        class="move-down p-1 text-gray-400 hover:text-gray-600"
                                                    ...
                                                    <button type="button"
                                                        class="remove-event ml-2 p-1 text-red-400 hover:text-red-600"
                                                        title="Hapus acara">
                                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                                                            stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-6">
                                                ...
                                                <div class="sm:col-span-2">
                                                    <label class="block text-sm font-medium text-gray-700">Jam
                                                        Mulai</label>
                                                ...
                                                <div class="sm:col-span-2">
                                                    ...
                                                    <div class="mt-1 flex items-center">
                                                        ...
                                                        <label class="ml-2 text-xs text-gray-500">Sampai
                                                            Selesai</label>
                                                    </div>
                                                </div>
                                                <div class="sm:col-span-6">
                                ...
                                <div class="mt-6">
                                    ...
                                    @error('timezone') <span class="text-red-500 text-xs">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                                ...
                                <div class="event-card bg-gray-50 p-4 rounded-xl border border-gray-200">
                                    ...
                                    <div class="flex items-center justify-between mb-4">
                                        <h4 class="font-semibold text-sm text-indigo-700">
                                            Acara Baru</h4>
                                        <div class="flex items-center gap-1">
                                            <button type="button" class="move-up p-1 text-gray-400 hover:text-gray-600"
                                                title="Pindah ke atas">
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl space-y-4">
                                    <div>
                                        <label for="slug-input" class="block text-sm font-medium text-gray-700">Tautan
                                            Kustom</label>
                                        <div class="mt-1 flex items-center gap-2">
                                            <span
                                                class="text-sm text-gray-500 whitespace-nowrap">{{ parse_url(config('app.url'), PHP_URL_HOST) }}/</span>
                                        ...
                                        <div id="slug-indicator"
                                            class="mt-1 text-xs flex items-center gap-1 text-gray-400">
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                ...
                                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        @error('theme') <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>

                                    <!-- Music Upload Section (Gold & Platinum Only) -->
                                    <div class="sm:col-span-6">
                                        <label class="block text-sm font-medium text-gray-700">Musik
                                            Latar Belakang
                                        ...
                                        @if($invitation->canUseCustomMusic())
                                            <div class="mt-1 space-y-2">
                                                @if($invitation->music_url)
                                                    <div
                                                        class="flex items-center gap-3 bg-indigo-50 p-3 rounded-lg border border-indigo-100">
                                        ...
                                        @else
                                            <div
                                                class="mt-1 bg-amber-50 border border-amber-100 rounded-lg p-4 flex items-center gap-3">
                                    ...
                                    <div class="sm:col-span-6">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 text-sm">
                                                <label for="is_active" class="font-medium text-gray-700">Aktifkan
                                                    Undangan</label>
    ...
    <div id="crop-modal" class="hidden fixed inset-0 z-50 bg-black/60 items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div class="p-4 border-b border-gray-100 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Crop
                    Foto</h3>
            ...
            <div class="p-4 border-t border-gray-100">
                <div class="flex items-center justify-center gap-3 mb-4">
                    <button type="button" id="crop-zoom-out"
                        class="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 transition" title="Perkecil">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                        </svg>
                    </button>
                    <button type="button" id="crop-zoom-in"
                        class="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 transition" title="Perbesar">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </button>
                    <button type="button" id="crop-rotate"
                        class="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 transition" title="Rotate">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex gap-3">
                    <button type="button"
                        class="crop-close flex-1 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition">
                        Batal
                    </button>
                    <button type="button" id="crop-save"
                        class="flex-1 px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl text-sm font-semibold hover:from-indigo-700 hover:to-indigo-800 transition shadow-sm">
                        Simpan
                    </button>
                </div>
            </div>
