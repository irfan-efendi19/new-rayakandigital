{{-- Crop Modal --}}
<div id="crop-modal"
    class="hidden fixed inset-0 z-50 bg-black/70 flex items-end sm:items-center justify-center sm:p-4" role="dialog"
    aria-modal="true" aria-labelledby="crop-modal-title">

    <div id="crop-modal-inner"
        class="relative w-full sm:max-w-2xl h-[92dvh] max-h-[92dvh] sm:h-auto sm:max-h-[90vh] bg-[#0f0f12] rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col">

        {{-- Header --}}
        <div class="flex items-center justify-between px-5 py-4 border-b border-white/[0.07] flex-shrink-0">
            <div class="flex items-center gap-3">
                <div
                    class="w-9 h-9 rounded-xl bg-primary-500/15 border border-primary-500/25 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <h3 id="crop-modal-title" class="text-base font-semibold text-white leading-tight">Sesuaikan
                        Foto</h3>
                    <p id="crop-modal-subtitle" class="text-xs text-white/40 mt-0.5">Geser & perbesar untuk memilih
                        area</p>
                </div>
            </div>
            <button type="button"
                class="crop-close w-8 h-8 rounded-lg bg-white/[0.06] hover:bg-white/[0.12] border border-white/[0.08] flex items-center justify-center text-white/50 hover:text-white transition-all">
        ...
        <div class="flex flex-col sm:flex-row flex-1 overflow-hidden min-h-0">
            ...
            <div class="relative bg-black flex-1 min-h-[240px] sm:min-h-[380px]">
                <div id="crop-loading"
                    class="hidden absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 bg-black/80">
            ...
            <div
                class="hidden sm:flex flex-col items-center justify-center gap-5 w-48 px-4 py-6 border-l border-white/[0.07] bg-white/[0.02] flex-shrink-0">
                <div>
                    <p class="text-[10px] font-semibold uppercase tracking-widest text-white/30 text-center mb-3">
                        Pratinjau</p>
        ...
        <div class="flex-shrink-0 border-t border-white/[0.07] bg-white/[0.02]">
            <div class="flex items-center gap-2 px-4 sm:px-5 py-3 overflow-x-auto no-scrollbar">
                <span
                    class="text-[10px] font-semibold uppercase tracking-widest text-white/25 mr-1 flex-shrink-0">Alat</span>
