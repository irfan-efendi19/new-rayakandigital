                                ...
                                <table class="min-w-full divide-y divide-neutral-200 dark:divide-secondary-700">
                                    <thead class="bg-neutral-50 dark:bg-secondary-700">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Terakhir Diupdate</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white dark:bg-secondary-800 divide-y divide-neutral-100 dark:divide-secondary-700">
                                        <template x-for="rsvp in displayRsvps" :key="rsvp.id">
                                            <tr class="hover:bg-neutral-50 dark:hover:bg-secondary-700 transition-colors">
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-secondary-800 dark:text-neutral-100" x-text="rsvp.guest_name"></td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-600 dark:text-neutral-400" x-text="rsvp.pax"></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-500 dark:text-neutral-400" x-text="rsvp.created_at"></td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-500 dark:text-neutral-400" x-text="rsvp.updated_at"></td>
                                            </tr>
                                        </template>
                                    </tbody>
                                </table>
                                <div x-show="totalFiltered === 0" class="text-center py-6 text-sm text-neutral-500 dark:text-neutral-400">
                                    Tidak ada tamu yang cocok dengan pencarian "<span x-text="search"></span>".
                                </div>
                                <div x-show="totalFiltered > 0" class="flex items-center justify-between pt-3 text-xs text-neutral-500 dark:text-neutral-400">
                                    <span>Menampilkan <span x-text="displayRsvps.length"></span> dari <span x-text="totalFiltered"></span> data</span>
                                </div>
                            </div>
                        </div>
                    @endif
