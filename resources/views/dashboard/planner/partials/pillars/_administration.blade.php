...
<div
    ...
    <div class="mt-4">
        <div class="h-2.5 overflow-hidden rounded-full bg-neutral-200/80 dark:bg-secondary-700/60">
            ...
            <div
                ...
                <ul class="divide-y divide-neutral-100 dark:divide-secondary-700/50">
                    @foreach($adminDocumentItems as $item)
                        <li class="px-4 py-3.5 transition-all duration-200 hover:bg-cyan-50/60 dark:hover:bg-secondary-700/30">
                            <p class="text-sm font-medium text-secondary-800 dark:text-neutral-100"
