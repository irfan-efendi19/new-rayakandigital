<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(session('warning'))
                <div class="mb-6 bg-amber-50 border border-amber-200 text-amber-800 px-6 py-4 rounded-xl relative flex items-start">
                    <svg class="w-5 h-5 mr-3 mt-0.5 text-amber-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @if(session('info'))
                <div class="mb-6 bg-blue-50 border border-blue-200 text-blue-800 px-6 py-4 rounded-xl">
                    {{ session('info') }}
                </div>
            @endif
