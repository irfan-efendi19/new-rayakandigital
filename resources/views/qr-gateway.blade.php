...
<body
    class="font-sans antialiased bg-gradient-to-br from-primary-50 via-white to-primary-50 dark:from-secondary-900 dark:via-secondary-900 dark:to-primary-950 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div
            class="bg-white dark:bg-secondary-800 rounded-3xl shadow-xl border border-neutral-100 dark:border-secondary-700 overflow-hidden">
            ...
            <div class="p-6">
                <div id="rsvp-form-container">
                    <div class="text-center mb-6">
                        <p class="text-neutral-600 dark:text-neutral-400 text-sm">
                            ...
                            <strong
                                class="text-secondary-800 dark:text-neutral-200">{{ $invitation->couple_name }}</strong>.
                        </p>
                    </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label
                                    ...
                                    <div class="text-center">
                                        <svg class="w-8 h-8 mx-auto text-emerald-500 mb-1" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span
                                            class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 peer-checked:text-emerald-700 dark:peer-checked:text-emerald-400">Hadir</span>
                                    </div>
                                </label>
                                <label
                                    ...
                                    <input type="radio" name="attendance" value="not_attending" required
                                        class="sr-only peer">
                                    <div class="text-center">
                                        <svg class="w-8 h-8 mx-auto text-red-400 mb-1" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                        <span
                                            class="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 peer-checked:text-red-600 dark:peer-checked:text-red-400">Tidak
                                            Hadir</span>
                                    </div>
                                </label>
                            </div>
                ...
                <div id="rsvp-success" class="hidden text-center py-8">
                    <div
                        class="w-16 h-16 mx-auto bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-8 h-8 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
