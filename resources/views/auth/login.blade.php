<x-guest-layout>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    class="rounded border-gray-300 dark:border-neutral-600 text-primary-600 shadow-sm focus:ring-primary-500 dark:bg-secondary-700" name="remember">
                <span class="ms-2 text-sm text-gray-600 dark:text-neutral-400">{{ __('Ingat saya') }}</span>
            </label>
        </div>
    ...
    <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
            <span class="bg-white dark:bg-[#2a2a4a] px-4 text-gray-500 dark:text-neutral-400">Atau masuk dengan</span>
        </div>
    </div>
