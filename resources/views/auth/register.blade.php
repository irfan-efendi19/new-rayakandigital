<x-guest-layout>
    ...
    <p class="mt-6 text-center text-sm text-gray-500 dark:text-neutral-500">
        Sudah punya akun?
        <a href="{{ route('login', request()->only(['theme', 'theme_id'])) }}" class="font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
            Masuk di sini →
        </a>
    </p>
