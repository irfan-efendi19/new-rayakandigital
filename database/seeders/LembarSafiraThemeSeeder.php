...
class LembarSafiraThemeSeeder extends Seeder
{
    public function run(): void
    {
        $theme = Theme::firstOrCreate(
            ['view_path' => 'themes.lembar_safira'],
            ['name' => 'Lembar Safira — Undangan Islami Swipe', 'thumbnail_portrait' => '/images/themes/lembar-safira-thumb.svg', 'is_premium' => true, 'is_active' => true],
        );
