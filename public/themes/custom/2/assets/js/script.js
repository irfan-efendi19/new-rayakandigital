(function () {
    ...
    if (audio && musicBtn) {
        // Auto-play is blocked by browsers; user must interact first via cover open
        ...
        wishForm.addEventListener('submit', function (e) {
            ...
            .then(function (data) {
                if (data.success) {
                    ...
                    form.reset();
                    if (form.querySelector('input[name="guest_name"]')) {
                        form.querySelector('input[name="guest_name"]').value = document.querySelector('input[name="guest_name"]')?.getAttribute('value') || '';
                    }
                } else {
                    alert(data.message || 'Terjadi kesalahan. Silakan coba lagi.');
                }
