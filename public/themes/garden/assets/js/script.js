        ...
        rsvpForm.addEventListener("submit", function (e) {
            ...
            fetch(form.action, {
                ...
                .then(function (data) {
                    if (data.success) {
                        form.innerHTML =
                            '<div class="success-msg">Terima kasih! Konfirmasi kehadiran Anda telah diterima.</div>';
                    } else {
                        alert(
                            data.message ||
            ...
            fetch(form.action, {
                ...
                .then(function (data) {
                    if (data.success) {
                        ...
                        item.innerHTML =
                            "<h4>" +
                            escapeHtml(data.wish.guest_name) +
                            "</h4>" +
                            "<p>" +
                            escapeHtml(data.wish.message) +
                            "</p>" +
